...
public class QnaDTO {
	...
	public QnaDTO(Long qnaSeq, String qnaTitle, String qnaContents, String qnaWriter, String qnaFile,
			Instant qnaWriteDate, Long qnaAnswerState, Long qnaPublic, String qnaCategory, Set<QnaFileDTO> files) {
		super();
		this.qnaSeq = qnaSeq;
	...
	public Set<QnaFileDTO> getFiles() {
		return files;
	}

	public void setFiles(Set<QnaFileDTO> files) {
		this.files = files;
	}
