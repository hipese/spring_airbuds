...
public class TrackService {
	...
	@Transactional
	public void insert(MultipartFile files, String name, String durations, String image_path, MultipartFile imagefile,
			String writer, Long[] tag, String releaseDate, String loginId) throws Exception {
...
//				값을 샛팅한 후 저장
	...
	@Transactional
	public TrackDTO updateTrack(Long trackId, String title, String previmagePath, MultipartFile imagefile,
			String writer, Long[] tag) throws Exception {
...
//			경로 교체
			ientity.setImagePath(iamgeblob.getMediaLink());
